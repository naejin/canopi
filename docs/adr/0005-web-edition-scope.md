...
- **Maps.** Web shows the same basemap and satellite providers as Desktop, with provider attribution. Google needs the user's own device key. No bundled tile pyramids, bulk download or offline archive. No local raster processing in Web.
