...
Renderer strategy was decided separately in [0007 Design Report PDF Renderer](0007-design-report-pdf-renderer.md), which is also superseded by ADR 0011. Canvas PDF export follows [ADR 0024](0024-shared-canvas-pdf-export.md); it does not reinstate this full-report scope.
