...
Web Edition v1 does not include the Design Notebook or a visible browser-local Drafts list. Browser Drafts are internal autosave/recovery state and must not use Notebook Sections, saved path references, file reveal actions, or notebook-style organization. See ADR 0010 and ADR 0014.
