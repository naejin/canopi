...
The Web Edition v1 may store personal app data in browser storage, such as IndexedDB and localStorage, without adding accounts, sync, or a backend persistence service. Browser-local app data includes Design drafts and autosave state, a simple Drafts list, settings, favorites, recently viewed Species, and Saved Object Stamps.
