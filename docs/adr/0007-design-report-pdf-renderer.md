...
[ADR 0011](0011-remove-design-report-export-and-display-modes.md) retired this renderer and report scope. [ADR 0024](0024-shared-canvas-pdf-export.md) defines the shared Canvas PDF pipeline using PDFKit and embedded Noto fonts. Native snapshot export never served as the structured report renderer.
