...
- A modal dialog is modal: while the save dialog (`app/document-session/save-problem.ts`) is open, `handleAppCommandKeyDown`, the Web canvas shortcuts and the command palette do nothing.
