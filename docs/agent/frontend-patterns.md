...
- The Planning Projection module owns derived planning rows, Timeline Action grouping/layout read-models, Timeline species picker options, runtime input assembly, and shared planning Target presentation primitives. Budget-specific Target presentation behavior belongs in the Budget Item Workbench.
