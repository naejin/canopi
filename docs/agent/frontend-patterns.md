...
- Web Edition v1 omits address search/geocoding and altitude editing. Location remains editable through manual latitude/longitude entry and map click. See `docs/adr/0016-web-edition-omits-geocoding.md`.
