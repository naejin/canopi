...
- Always-visible choice rows should use the dedicated responsive choice-chip layout. Do not rely on generic flex chip packing for row-height behavior; fixed chip widths can appear stuck at two rows across normal sidebar widths.
