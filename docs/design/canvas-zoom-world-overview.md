...
Status: implemented under bead `canopi-85wo`; local source, test, UI and edition-build gates pass. Private-fixture performance and native OS qualification remain unavailable and are not claimed as release evidence.
