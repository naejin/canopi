...
Status: proposed — product direction and import grouping accepted; a gallery-only interactive reference is delivered for review. Production migration is not yet authorized.
