...
The [raster, Data and Analysis rework](design/raster-data-analysis-rework.md) records simplified bounded import, selective GeoLibre native integration, Desktop workbenches, and Web Location scope. Native extraction/postprocessing is independently accepted at `a5fc7d7b`. Bounded generations delivered at `eb64a853` are [partially reviewed](design/raster-rework/bounded-generation-review.md), not accepted as complete or integrated; the pagination/lifecycle completion is delivered on the existing branch/bead and recorded in the [receipt](design/raster-rework/bounded-generation-receipt.md), under the [design](design/raster-rework/bounded-generation-design.md). [ADR 0026](adr/0026-sparse-raster-generations.md) retains the standard-COG storage decision. Q remains frozen. The [handoff folder](design/raster-rework/README.md) retains review/debrief evidence separately from execution state in bd. New workbench and basemap UI remains later work.
