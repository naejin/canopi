...
The proposed [whole-application GeoLibre adoption plan](design/raster-rework/geolibre-adoption-plan.md) addresses the subsequent display-performance and UX reports while preserving all current Canopi capabilities. It maps upstream reuse, domain ownership, migration, Data/Analysis/Layers UX, TDD, whole-app acceptance and delivery. On 2026-09-24 the user accepted upstream display semantics, preservation of current edition capabilities and GeoLibre slope for new analyses. Existing Horn definitions/results retain their method; new definitions record a distinct recipe version. ADR 0027 records the display amendment and links the method decision. Implementation remains separate. The [debrief](design/raster-rework/review-and-debrief.md#whole-rework-delivery-and-improvement) retains measured outcomes; bd owns execution state.
