...
- [Agent Guide](./agents.md) — minimal reading order for agents
- [Docs Maintenance](./maintenance.md) — how to update docs

## Archive

- [Archive README](./archive/README.md) — historical phase notes, roadmap, reviews, rewrite history
