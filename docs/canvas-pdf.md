...
actual total PDF page count. Review the sheets, then choose **Apply sheets** or **Cancel**.
The original setup remains unchanged until Apply. Splitting covers the full requested
rectangle, including empty ground, and never happens automatically. Very crowded or
coincident placements may still need closer framing; splitting cannot separate plants
at exactly the same position.

The selected sheet is prepared first. Unchanged field layouts are reused when you
adjust another page. Preview artwork appears before final PDF encoding completes;
**Save PDF** becomes available once the current complete document is ready.
