...
| timeline tools | Active — bottom-panel tab with month/year views, drag-to-move, species-grouped lanes | shipped | Wave 3 | Plan time-based work and scheduling inside a design | Timeline tab with action CRUD, granularity toggle, and drag-to-move |
