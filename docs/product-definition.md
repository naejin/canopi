...
| timeline tools | Hidden — tab removed from `VISIBLE_BOTTOM_PANEL_TABS` pending rework; code retained | shipped (hidden) | Wave 3 | Plan time-based work and scheduling inside a design | Timeline tab with action CRUD, granularity toggle, and drag-to-move |
