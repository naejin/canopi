...
async function main() {
  ...
  // The import map is generated by the TypeScript tooling (the Python helper this
  // replaces was retired with its last consumer). The runner compiles it before the
  // probe steps.
  await new Promise((done, fail) => {
    const child = spawn(process.execPath, [
      resolve(HARNESS, "ts/dist/src/importMap.js"), "--bench", bench, "--out", importMapPath,
      "--extra-map", nodeStubs,
