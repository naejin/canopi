...
describe('frontend boundary sources', () => {
  ...
  it('keeps Timeline Action workbench and drag edits behind app/timeline modules', () => {
    ...
    expect(canvasWorkbenchSource).not.toContain('createTimelineResizeDrag')
    expect(canvasWorkbenchSource).not.toContain('timelineAutoScrollSpeed')
    expect(canvasWorkbenchSource).not.toContain('restoreTimelineOriginScroll')
    expect(canvasWorkbenchSource).not.toContain('setTimelineHoveredPanelTargets')
    expect(canvasWorkbenchSource).not.toContain('setTimelineSelectedPanelTargets')
    expect(canvasWorkbenchSource).not.toContain('deleteSelectedTimelineAction')
    expect(canvasWorkbenchSource).not.toContain('saveTimelineActionPopover')
