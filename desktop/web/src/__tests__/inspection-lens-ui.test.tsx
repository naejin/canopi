...
it('opens the optional lens, identifies plants and releases the view on Escape', async () => {
  ...
  const view: CanvasInspectionHandle = {
    state: signal({ point: { x: 0, y: 0 }, held: false, scale: 10, zoomPercent: 700, previewAvailable: true, frame: { width: 430, height: 390 },
    ...
    inspect: vi.fn(), panBy: vi.fn(), setHeld: vi.fn(), zoomBy: vi.fn(), highlightPlant: vi.fn(), focusPlant: vi.fn(), dispose: vi.fn(),
  }
